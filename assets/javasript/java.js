...
//$(".btn").on("click", function() {
 // var nationalPark = $(this).val();
 // var search = nationalPark.toLowerCase().replace(/\s+/g, '');
 // console.log(nationalPark+"and"+search);

   
  //   // Here we construct our URL
  //   var queryURL ="https://developer.nps.gov/api/v1/parks?parkCode="+search+"&api_key=gF8jCoYy8ylO1ws3b3WsiYuC3vZe9y0mGd5dA5cc";
  ...
  //     $("#generalInfo").append(response.data[0].url);
  //    // $("#run-search").text(JSON.stringify(response));
  //   });
